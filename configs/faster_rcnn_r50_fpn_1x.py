...
data_root = '/ligang/Dataset/citypersons/'
img_norm_cfg = dict(
...
log_level = 'INFO'
work_dir = '/ligang/Works/DFL_Nighttime/Experiments/SpatialAttention/citypersons/debug'
load_from = None
resume_from = None
workflow = [('train', 1)]
